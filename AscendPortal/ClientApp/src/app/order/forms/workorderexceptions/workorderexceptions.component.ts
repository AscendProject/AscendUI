...
@Component({
    selector: 'workorderexceptions',
    templateUrl: './workorderexceptions.component.html',
    styleUrls: ['./workorderexceptions.component.scss']
})
export class WorkorderExceptionsComponent {
